 ...
 *         &lt;element name="CmsGeneralReservation" type="{http://education.ws.edusys.mftvanak.com/schemas/types}CmsGeneralReservationType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType (name = "", propOrder = {"clientDateTimeYear", "clientDateTimeMonth", "clientDateTimeDay",
    ...
    "clientMacAddress", "clientIpAddress", "clientComputerName", "applicationName", "token", "cmsGeneralReservation"})
@XmlRootElement (name = "UpdateCmsGeneralReservationRequest")
public class UpdateCmsGeneralReservationRequest {
  ...
  @XmlElement (name = "CmsGeneralReservation", required = true)
  protected CmsGeneralReservationType cmsGeneralReservation;
  ...
  /**
   * Gets the value of the cmsGeneralReservation property.
   * 
   * @return possible object is {@link CmsGeneralReservationType }
   * 
   */
  public CmsGeneralReservationType getCmsGeneralReservation () {
    return cmsGeneralReservation;
  }

  /**
   * Sets the value of the cmsGeneralReservation property.
   * 
   * @param value
   *          allowed object is {@link CmsGeneralReservationType }
   * 
   */
  public void setCmsGeneralReservation (CmsGeneralReservationType value) {
    this.cmsGeneralReservation = value;
  }
