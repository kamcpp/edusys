...
(function(jQuery, window, undefined) {
  ...
  jQuery.attr = function(elem, name, value, pass) {
    ...
    if (!jQuery.attrHooks[lowerName] && rboolean.test(lowerName)) {
      ...
      // Warn only for attributes that can remain distinct from their properties
      // post-1.9
      ...
      if (fragment) {
        ...
        handleScript = function(elem) {
          ...
          if (!elem.type || rscriptType.test(elem.type)) {
            ...
            return scripts ? scripts.push(elem.parentNode ? elem.parentNode
                .removeChild(elem) : elem) : fragment.appendChild(elem);
          }
        };
  ...
  jQuery.event.remove = function(elem, types, handler, selector, mappedTypes) {
    eventRemove.call(this, elem, hoverHack(types) || "", handler, selector,
        mappedTypes);
  };
