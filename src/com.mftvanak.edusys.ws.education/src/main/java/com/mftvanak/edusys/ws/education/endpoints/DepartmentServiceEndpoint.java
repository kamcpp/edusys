...
import com.mftvanak.edusys.ws.education.schemas.department.AddDepartmentRequest;
import com.mftvanak.edusys.ws.education.schemas.department.AddDepartmentResponse;
import com.mftvanak.edusys.ws.education.schemas.department.DeleteDepartmentRequest;
import com.mftvanak.edusys.ws.education.schemas.department.DeleteDepartmentResponse;
import com.mftvanak.edusys.ws.education.schemas.department.GetDepartmentByIdRequest;
import com.mftvanak.edusys.ws.education.schemas.department.GetDepartmentByIdResponse;
import com.mftvanak.edusys.ws.education.schemas.department.GetDepartmentsRequest;
import com.mftvanak.edusys.ws.education.schemas.department.GetDepartmentsResponse;
import com.mftvanak.edusys.ws.education.schemas.department.UpdateDepartmentRequest;
import com.mftvanak.edusys.ws.education.schemas.department.UpdateDepartmentResponse;
import com.mftvanak.edusys.ws.education.schemas.types.DepartmentType;
...
public class DepartmentServiceEndpoint {
  ...
  AddDepartmentResponse handleAddDepartmentRequest (@RequestPayload AddDepartmentRequest request)
    ...
    if (request.getClientDateTimeYear () >= 0 && request.getClientDateTimeMonth () >= 0
      ...
      auditService.addAuditLog (token, "AddDepartment", "DepartmentService", "0.0.1", "Adding department with name '"
          + request.getDepartment ().getPersianName () + "'", "", clientDateTime.getMillis (),
          request.getClientMacAddress (), request.getClientIpAddress (), request.getClientComputerName (),
          request.getApplicationName ());
    } else {
      throw new ClientInformationNeededException ();
    }
    Institute institute = instituteService.getEntityById (request.getDepartment ().getInstituteId ());
    if (institute == null) {
    ...
    department.setSeoDescription (request.getDepartment ().getSeoDescription ());
    department.setInstitute (institute);
    Long id = departmentService.addEntity (department);
    DateTime clientDateTime = new DateTime (request.getClientDateTimeYear (), request.getClientDateTimeMonth (),
        request.getClientDateTimeDay (), request.getClientDateTimeHour (), request.getClientDateTimeMinute (),
        request.getClientDateTimeSecond (), request.getClientDateTimeMilliSecond (), DateTimeZone.UTC);
    auditService.addAuditLog (token, "AddDepartment", "DepartmentService", "0.0.1", "Department is added with id '"
        + request.getDepartment ().getId () + "'", "", clientDateTime.getMillis (), request.getClientMacAddress (),
  ...
  public @ResponsePayload
  UpdateDepartmentResponse handleUpdateDepartmentRequest (@RequestPayload UpdateDepartmentRequest request)
      throws TokenIsNotAuthenticatedException, UserIsNotAuthorizedException, DepartmentNotFoundException,
    ...
    if (request.getClientDateTimeYear () >= 0 && request.getClientDateTimeMonth () >= 0
      ...
      DateTime clientDateTime = new DateTime (request.getClientDateTimeYear (), request.getClientDateTimeMonth (),
          request.getClientDateTimeDay (), request.getClientDateTimeHour (), request.getClientDateTimeMinute (),
          request.getClientDateTimeSecond (), request.getClientDateTimeMilliSecond (), DateTimeZone.UTC);
      auditService.addAuditLog (token, "UpdateDepartment", "DepartmentService", "0.0.1",
          "Updating department with id '" + request.getDepartment ().getId () + "'", "", clientDateTime.getMillis (),
          request.getClientMacAddress (), request.getClientIpAddress (), request.getClientComputerName (),
          request.getApplicationName ());
    } else {
      throw new ClientInformationNeededException ();
    }
    Department department = departmentService.getEntityById (request.getDepartment ().getId ());
    if (department == null) {
  ...
  public @ResponsePayload
  DeleteDepartmentResponse handleDeleteDepartmentRequest (@RequestPayload DeleteDepartmentRequest request)
      throws TokenIsNotAuthenticatedException, UserIsNotAuthorizedException, DepartmentNotFoundException,
      UserIsNotActiveException, ClientInformationNeededException {
    Token token = securityService.authenticateAndAuthorizeToken (request.getToken ());
    if (request.getClientMacAddress () == null || request.getClientIpAddress () == null
    ...
    if (request.getClientDateTimeYear () >= 0 && request.getClientDateTimeMonth () >= 0
      ...
      DateTime clientDateTime = new DateTime (request.getClientDateTimeYear (), request.getClientDateTimeMonth (),
          request.getClientDateTimeDay (), request.getClientDateTimeHour (), request.getClientDateTimeMinute (),
          request.getClientDateTimeSecond (), request.getClientDateTimeMilliSecond (), DateTimeZone.UTC);
      auditService.addAuditLog (token, "DeleteDepartment", "DepartmentService", "0.0.1",
          "Updating department with id '" + request.getDepartmentId () + "'", "", clientDateTime.getMillis (),
          request.getClientMacAddress (), request.getClientIpAddress (), request.getClientComputerName (),
          request.getApplicationName ());
    } else {
      throw new ClientInformationNeededException ();
  ...
  public @ResponsePayload
  GetDepartmentByIdResponse handleGetDepartmentByIdRequest (@RequestPayload GetDepartmentByIdRequest request)
      throws TokenIsNotAuthenticatedException, UserIsNotAuthorizedException, UserIsNotActiveException,
    ...
    if (request.getClientDateTimeYear () >= 0 && request.getClientDateTimeMonth () >= 0
      ...
      DateTime clientDateTime = new DateTime (request.getClientDateTimeYear (), request.getClientDateTimeMonth (),
          request.getClientDateTimeDay (), request.getClientDateTimeHour (), request.getClientDateTimeMinute (),
          request.getClientDateTimeSecond (), request.getClientDateTimeMilliSecond (), DateTimeZone.UTC);
      auditService.addAuditLog (token, "GetDepartmentById", "DepartmentService", "0.0.1",
          "Getting department with id '" + request.getDepartmentId () + "'", "", clientDateTime.getMillis (),
          request.getClientMacAddress (), request.getClientIpAddress (), request.getClientComputerName (),
          request.getApplicationName ());
    } else {
      throw new ClientInformationNeededException ();
  ...
  public @ResponsePayload
  GetDepartmentsResponse handleGetDepartmentsRequest (@RequestPayload GetDepartmentsRequest request)
    ...
    if (request.getClientDateTimeYear () >= 0 && request.getClientDateTimeMonth () >= 0
      ...
      DateTime clientDateTime = new DateTime (request.getClientDateTimeYear (), request.getClientDateTimeMonth (),
          request.getClientDateTimeDay (), request.getClientDateTimeHour (), request.getClientDateTimeMinute (),
          request.getClientDateTimeSecond (), request.getClientDateTimeMilliSecond (), DateTimeZone.UTC);
      auditService.addAuditLog (token, "GetDepartments", "DepartmentService", "0.0.1", "Getting all departments", "",
    ...
    for (Department department : departmentService.getByInstituteId (request.getInstituteId ())) {
      DepartmentType departmentType = new DepartmentType ();
      departmentType.setId (department.getId ());
      departmentType.setInstituteId (department.getInstitute ().getId ());
      departmentType.setPersianName (department.getPersianName ());
