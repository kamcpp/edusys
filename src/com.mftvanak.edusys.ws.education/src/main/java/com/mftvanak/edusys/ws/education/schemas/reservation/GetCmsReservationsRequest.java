 ...
 *         &lt;element name="ReservationPlanId" type="{http://www.w3.org/2001/XMLSchema}long"/>
...
@XmlType (name = "", propOrder = {"clientDateTimeYear", "clientDateTimeMonth", "clientDateTimeDay",
    ...
    "clientMacAddress", "clientIpAddress", "clientComputerName", "applicationName", "token", "departmentId",
    "reservationPlanId", "count"})
@XmlRootElement (name = "GetCmsReservationsRequest")
public class GetCmsReservationsRequest {
  ...
  @XmlElement (name = "ReservationPlanId")
  protected long reservationPlanId;
  ...
  /**
   * Gets the value of the reservationPlanId property.
   * 
   */
  public long getReservationPlanId () {
    return reservationPlanId;
  }

  /**
   * Sets the value of the reservationPlanId property.
   * 
   */
  public void setReservationPlanId (long value) {
    this.reservationPlanId = value;
  }
