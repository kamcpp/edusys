...
CREATE TABLE reservation (
    ...
    source character varying(10240)
);
...
CREATE TABLE term (
    id bigint DEFAULT nextval('term_id_seq1'::regclass) NOT NULL,
    english_name character varying(5120) NOT NULL,
    persian_name character varying(5120) NOT NULL,
    institute_id bigint NOT NULL
);
...
CREATE TABLE message_template (
    id bigint DEFAULT nextval('message_template_id_seq1'::regclass) NOT NULL,
    description character varying(20480),
    name character varying(5120) NOT NULL,
...
CREATE TABLE send_request (
    id bigint DEFAULT nextval('send_request_id_seq1'::regclass) NOT NULL,
    description character varying(20480),
    name character varying(5120) NOT NULL,
...
CREATE TABLE sendlist (
    id bigint DEFAULT nextval('sendlist_id_seq1'::regclass) NOT NULL,
