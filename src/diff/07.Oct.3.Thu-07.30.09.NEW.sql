...
--
-- Name: message_template_id_seq; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE message_template_id_seq OWNED BY message_template.id;
...
--
-- Name: send_request_id_seq; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE send_request_id_seq OWNED BY send_request.id;
...
--
-- Name: sendlist_id_seq; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE sendlist_id_seq OWNED BY sendlist.id;
...
ALTER TABLE ONLY message_template ALTER COLUMN id SET DEFAULT nextval('message_template_id_seq'::regclass);
...
ALTER TABLE ONLY send_request ALTER COLUMN id SET DEFAULT nextval('send_request_id_seq'::regclass);
...
ALTER TABLE ONLY sendlist ALTER COLUMN id SET DEFAULT nextval('sendlist_id_seq'::regclass);
