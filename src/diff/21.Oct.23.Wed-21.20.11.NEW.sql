...
--
-- Name: term_id_seq1; Type: SEQUENCE; Schema: education; Owner: edusysuser
--
...
ALTER TABLE education.term_id_seq1 OWNER TO edusysuser;

--
-- Name: term_id_seq1; Type: SEQUENCE OWNED BY; Schema: education; Owner: edusysuser
--

ALTER SEQUENCE term_id_seq1 OWNED BY term.id;
...
--
-- Name: message_template; Type: TABLE; Schema: messaging; Owner: edusysuser; Tablespace: 
--
...
ALTER TABLE messaging.message_template OWNER TO edusysuser;

--
-- Name: message_template_id_seq; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.message_template_id_seq OWNER TO edusysuser;

--
-- Name: message_template_id_seq1; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.message_template_id_seq1 OWNER TO edusysuser;

--
-- Name: message_template_id_seq1; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE message_template_id_seq1 OWNED BY message_template.id;


--
-- Name: send_request; Type: TABLE; Schema: messaging; Owner: edusysuser; Tablespace: 
--
...
ALTER TABLE messaging.send_request OWNER TO edusysuser;

--
-- Name: send_request_id_seq; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.send_request_id_seq OWNER TO edusysuser;

--
-- Name: send_request_id_seq1; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.send_request_id_seq1 OWNER TO edusysuser;

--
-- Name: send_request_id_seq1; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE send_request_id_seq1 OWNED BY send_request.id;


--
-- Name: sendlist; Type: TABLE; Schema: messaging; Owner: edusysuser; Tablespace: 
--
...
ALTER TABLE messaging.sendlist OWNER TO edusysuser;

--
-- Name: sendlist_id_seq; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.sendlist_id_seq OWNER TO edusysuser;

--
-- Name: sendlist_id_seq1; Type: SEQUENCE; Schema: messaging; Owner: edusysuser
--
...
ALTER TABLE messaging.sendlist_id_seq1 OWNER TO edusysuser;

--
-- Name: sendlist_id_seq1; Type: SEQUENCE OWNED BY; Schema: messaging; Owner: edusysuser
--

ALTER SEQUENCE sendlist_id_seq1 OWNED BY sendlist.id;
...
--
-- Name: todo_item_attachement; Type: TABLE; Schema: messaging; Owner: edusysuser; Tablespace: 
--
...
ALTER TABLE messaging.todo_item_attachement OWNER TO edusysuser;
...
ALTER TABLE ONLY term ALTER COLUMN id SET DEFAULT nextval('term_id_seq1'::regclass);
...
ALTER TABLE ONLY message_template ALTER COLUMN id SET DEFAULT nextval('message_template_id_seq1'::regclass);
...
ALTER TABLE ONLY send_request ALTER COLUMN id SET DEFAULT nextval('send_request_id_seq1'::regclass);
...
ALTER TABLE ONLY sendlist ALTER COLUMN id SET DEFAULT nextval('sendlist_id_seq1'::regclass);
...
--
-- Name: message_template_pkey; Type: CONSTRAINT; Schema: messaging; Owner: edusysuser; Tablespace: 
--
...
--
-- Name: send_request_pkey; Type: CONSTRAINT; Schema: messaging; Owner: edusysuser; Tablespace: 
--

ALTER TABLE ONLY send_request
    ADD CONSTRAINT send_request_pkey PRIMARY KEY (id);


--
-- Name: sendlist_pkey; Type: CONSTRAINT; Schema: messaging; Owner: edusysuser; Tablespace: 
--

ALTER TABLE ONLY sendlist
    ADD CONSTRAINT sendlist_pkey PRIMARY KEY (id);


--
-- Name: todo_item_attachement_pkey; Type: CONSTRAINT; Schema: messaging; Owner: edusysuser; Tablespace: 
--

ALTER TABLE ONLY todo_item_attachement
...
--
-- Name: fk3a5133cb2cb465a; Type: FK CONSTRAINT; Schema: messaging; Owner: edusysuser
--
...
--
-- Name: fk41715b222a99445; Type: FK CONSTRAINT; Schema: messaging; Owner: edusysuser
--
...
--
-- Name: fk4a657c2622a99445; Type: FK CONSTRAINT; Schema: messaging; Owner: edusysuser
--
...
--
-- Name: fk4a657c2663d5d7d6; Type: FK CONSTRAINT; Schema: messaging; Owner: edusysuser
--
...
--
-- Name: fke33060d822a99445; Type: FK CONSTRAINT; Schema: messaging; Owner: edusysuser
--
