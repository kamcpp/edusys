 ...
 *         &lt;element name="JustToday" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="Predicate" type="{http://phonebook.ws.edusys.mftvanak.com/schemas}PhoneEntrySearchPredicateType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetPhoneEntriesByPredicateRequest")
public class GetPhoneEntriesByPredicateRequest {
    ...
    @XmlElement(name = "JustToday")
    protected boolean justToday;
    @XmlElement(name = "Predicate", required = true)
    protected PhoneEntrySearchPredicateType predicate;
    ...
    /**
     * Gets the value of the justToday property.
     * 
     */
    public boolean isJustToday() {
        return justToday;
    }

    /**
     * Sets the value of the justToday property.
     * 
     */
    public void setJustToday(boolean value) {
        this.justToday = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link PhoneEntrySearchPredicateType }
     *     
     */
    public PhoneEntrySearchPredicateType getPredicate() {
        return predicate;
    }
     ...
     *     
     */
    public void setPredicate(PhoneEntrySearchPredicateType value) {
