 ...
 *         &lt;element name="SendListItem" type="{http://messaging.ws.edusys.mftvanak.com/schemas/types}SendListItemType"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddSendListItemRequest")
public class AddSendListItemRequest {
    ...
    @XmlElement(name = "SendListItem", required = true)
    protected SendListItemType sendListItem;
    ...
    /**
     * Gets the value of the sendListItem property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public SendListItemType getSendListItem() {
        return sendListItem;
    }

    /**
     * Sets the value of the sendListItem property.
     * 
     * @param value
     *     allowed object is
     *     {@link SendListItemType }
     *     
     */
    public void setSendListItem(SendListItemType value) {
        this.sendListItem = value;
    }
