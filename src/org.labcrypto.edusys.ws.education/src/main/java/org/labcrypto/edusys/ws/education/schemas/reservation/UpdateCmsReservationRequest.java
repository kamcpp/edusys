 ...
 *         &lt;element name="CmsReservation" type="{http://education.ws.edusys.mftvanak.com/schemas/types}CmsReservationType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType (name = "", propOrder = {"clientDateTimeYear", "clientDateTimeMonth", "clientDateTimeDay",
    ...
    "clientMacAddress", "clientIpAddress", "clientComputerName", "applicationName", "token", "cmsReservation"})
@XmlRootElement (name = "UpdateCmsReservationRequest")
public class UpdateCmsReservationRequest {
  ...
  @XmlElement (name = "CmsReservation", required = true)
  protected CmsReservationType cmsReservation;
  ...
  /**
   * Gets the value of the cmsReservation property.
   * 
   * @return possible object is {@link CmsReservationType }
   * 
   */
  public CmsReservationType getCmsReservation () {
    return cmsReservation;
  }

  /**
   * Sets the value of the cmsReservation property.
   * 
   * @param value
   *          allowed object is {@link CmsReservationType }
   * 
   */
  public void setCmsReservation (CmsReservationType value) {
    this.cmsReservation = value;
  }
