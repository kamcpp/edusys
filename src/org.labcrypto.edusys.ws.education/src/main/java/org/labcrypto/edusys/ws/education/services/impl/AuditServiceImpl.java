...
public class AuditServiceImpl implements AuditService {
	...
	public void addAuditLog(Token token, String operation, String service,
		...
		auditFacade.addAuditLog(UUID.randomUUID().toString(),
				...
				operation, token != null ? token.getId() : null,
				token != null ? token.getUser().getPersonId() : -1,
				token != null ? token.getUser().getUsername() : "null",
				clientMacAddress, clientIpAddress, clientComputerName,
				localAddress, remoteAddress, service, serviceVersion,
